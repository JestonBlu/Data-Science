...
##### **Overview**
This script creates a function for running a simple bootstrap simulation from a given input. In this example I am using the data set BJsales from R. Bootstrap simulations work by pulling a series of random **events** from the past and stringing them together to produce a possible future outcome.        
...
Access the script [here](https://github.com/JestonBlu/reference/blob/gh-pages/r_scripts/boot_bjsales.r).
...
```{r plots, message=FALSE, fig.height=7}
