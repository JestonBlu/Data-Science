...
```{r cn01, comment=NA, echo=FALSE, results='asis'}
library(pander)
...
pandoc.table(dta, caption = "Data for applicant entrance for 6 departments")

```

```{r cn02, comment=NA, results='asis'}
...
```{r cn04, comment=NA, warning=FALSE, message=FALSE}
library(DescTools)
library(lawstat)
