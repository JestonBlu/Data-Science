...
- **Parameters**: $\alpha_i = \text{supp, } \beta_j = \text{dose}$  
...
data("ToothGrowth")
head(ToothGrowth); summary(ToothGrowth)
...
- **Equal Variance**: Brown-Forsythe-Levene test of confirms equal variance supported by the residual plot
